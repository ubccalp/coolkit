...
router.get('/a1-p2', (req, res) => {
    res.render('step-3-activity-1-p2', { title: 'Rate Your Household | Coolkit' });
});
...
router.get('/a2-p2', (req, res) => {
    res.render('step-3-activity-2-p2', { title: 'Rate Your Block | Coolkit' });
});
